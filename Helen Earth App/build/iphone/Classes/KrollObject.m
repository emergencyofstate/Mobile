 ...
 * Copyright (c) 2009-2011 by HelenEarthApp, Inc. All Rights Reserved.
...
//@interface HelenEarthAppObject : NSObject
//@end

@interface HelenEarthAppObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[HelenEarthAppObject class]])
		{
			for (NSString *key in [[(HelenEarthAppObject*)o modules] allKeys])
			{
