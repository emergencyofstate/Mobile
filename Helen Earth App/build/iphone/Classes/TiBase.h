...
// in simulator we redefine to format for HelenEarthApp Developer console
...
{\
	NSString * exceptionName = [@"org.helenearthapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.helenearthapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIHelenEarthAppNativeItemNone = -1, 
	UIHelenEarthAppNativeItemSpinner = -2,
	UIHelenEarthAppNativeItemProgressBar = -3,
	
	UIHelenEarthAppNativeItemSlider = -4,
	UIHelenEarthAppNativeItemSwitch = -5,
	UIHelenEarthAppNativeItemMultiButton = -6,
	UIHelenEarthAppNativeItemSegmented = -7,
	
	UIHelenEarthAppNativeItemTextView = -8,
	UIHelenEarthAppNativeItemTextField = -9,
	UIHelenEarthAppNativeItemSearchBar = -10,
	
	UIHelenEarthAppNativeItemPicker = -11,
	UIHelenEarthAppNativeItemDatePicker = -12,
	
	UIHelenEarthAppNativeItemInfoLight = -13,
	UIHelenEarthAppNativeItemInfoDark = -14,
	
	UIHelenEarthAppNativeItemDisclosure = -15,
	
	UIHelenEarthAppNativeItemContactAdd = -16
};
