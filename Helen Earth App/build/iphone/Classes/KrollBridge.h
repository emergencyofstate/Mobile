...
@interface HelenEarthAppObject : KrollCoverageObject {
#else
@interface HelenEarthAppObject : KrollObject {
#endif
@private
...
extern NSString * HelenEarthApp$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	HelenEarthAppObject *_helenearthapp;
	BOOL shutdown;
